...
- **Clone** the repository:
   ...
   ```bash
   git clone https://github.com/jebamalarp/COLLEGE-WEBSITE/

- **Add This repo as Remote**  :

   ```bash
   git remote add origin https://github.com/jebamalarp/COLLEGE-WEBSITE/
...
- Name - <a href="https://github.com/jebamalarp/COLLEGE-WEBSITE/">MALAR</a>


- Project Link - [College-Website](https://github.com/jebamalarp/COLLEGE-WEBSITE/)
